        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateLastOnline = table.Column<DateTime>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ManagerCalls", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ManagerCalls_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ManagerCalls_UserProfiles_UserProfileId",
                        column: x => x.UserProfileId,
                        principalTable: "UserProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderUsers_UserProfiles_UserProfileId",
                        column: x => x.UserProfileId,
                        principalTable: "UserProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceWithSales = table.Column<decimal>(nullable: true),
                    IsActive = table.Column<bool>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MenuItems_FileModels_FileModelId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ManagerCalls_OrderId",
                table: "ManagerCalls",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_ManagerCalls_UserProfileId",
                table: "ManagerCalls",
                column: "UserProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderUsers_UserProfileId",
                table: "OrderUsers",
                column: "UserProfileId");
